...
#for showing signup/login button for admin(by admin)
...
#for showing signup/login button for doctor(by admin)
...
#for showing signup/login button for patient(by admin)
...
#-----------for checking user is doctor , patient or admin(by admin)
def is_admin(user):
